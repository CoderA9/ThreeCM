...
/**
 `LXJSONRequestOperation` is a subclass of `LXHTTPRequestOperation` for downloading and working with JSON response data.
 
 ## Acceptable Content Types
 
 By default, `LXJSONRequestOperation` accepts the following MIME types, which includes the official standard, `application/json`, as well as other commonly-used types:
 
 - `application/json`
 - `text/json`
 */
@interface LXJSONRequestOperation : LXHTTPRequestOperation {
@private
    id _responseJSON;
    NSError *_JSONError;
}
...
/**
 Creates and returns an `LXJSONRequestOperation` object and sets the specified success and failure callbacks.
